# www_notion_so Patterns

## Developer Instructions
This folder contains the UI patterns extracted from www_notion_so. The `pages` folder contains the hierarchical DOM structure and computed styles (colors, layout) mapping to W3C Design Tokens.
