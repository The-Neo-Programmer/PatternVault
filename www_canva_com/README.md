# www_canva_com Patterns

## Developer Instructions
This folder contains the UI patterns extracted from www_canva_com. The `pages` folder contains the hierarchical DOM structure and computed styles (colors, layout) mapping to W3C Design Tokens.
