...
This folder contains the UI patterns extracted from stripe_com. The `pages` folder contains the hierarchical DOM structure and computed styles (colors, layout) mapping to W3C Design Tokens.
